...
STRINGS = {
    "en": {
        ...
        "login_community_title": "\n[INFO] Collective Intelligence Network (Reciprocal Community):",
        "login_community_desc": "   Enables synchronization of optimal bias discovered by winning nodes.\n   Under the Reciprocal Rule, receiving community bias requires contributing anonymous post-shot metrics.",
        "login_community_prompt": "Do you want to participate in the Collective Intelligence Network? (Y/n): ",
        ...
        "status_is_pass": "• Permission State: {is_pass}",
        ...
        # Button and Pass state human mappings
        "btn_ready": "[ENABLED] Ready to apply for quota (code 1)",
        "btn_cooldown": "[COOLDOWN] Temporarily rate-limited (code 2)",
        "btn_too_new": "[RESTRICTED] Account younger than 30 days (code 3)",
        "btn_unknown": "[UNKNOWN] State not recognized (code {state})",
        "pass_approved": "[APPROVED] Permission already active (code 1)",
        "pass_pending": "[PENDING] Not approved yet, daily quota required (code 4)",
        "pass_unknown": "[UNKNOWN] Permission state {is_pass}",
        # Schedule
        ...
        "res_account_error": "[ACCOUNT_ERROR] Account error. Please retry after {deadline}.",
        "res_exhausted": "[EXHAUSTED] Daily quota exhausted. Quotas closed before processing your request. Next opening: {deadline}.",
        "res_apply_failed": "[FAILED] Application failed. Please try again later.",
        "res_try_minute": "[WAIT] Please try again in a minute.",
        ...
        # Validator & USB assistant
        "val_silent_pass_alert": "\n=================================================================\n[NOTICE - POTENTIAL SILENT APPROVAL DETECTED]\nXiaomi servers were congested. It is very common that the request\nwas approved in the database even if the API returned exhausted.\n=================================================================",
        "val_silent_prompt_ask": "Do you want to verify your real bootloader status now? (Y/n): ",
        "val_prompt_header": " [USB BOOTLOADER AUDIT ASSISTANT]\n Connect your phone via USB cable to this machine:\n   • Option 1: Powered on normally with USB Debugging enabled (ADB).\n   • Option 2: Powered off in FASTBOOT mode (Volume Down + Power).",
        "val_prompt_instructions": " Ensure USB cable is firmly connected before pressing Enter.",
        "val_prompt_press_enter": "\nPress [ENTER] when connected (or type 's' to skip): ",
        "val_prompt_retry": "Do you want to retry USB connection? (Y/n): ",
        "val_no_device_found": "[!] No device detected in USB (ADB or Fastboot).",
        "val_adb_unauth_notice": "\n-----------------------------------------------------------------\n[ADB AUTHORIZATION NOTICE]:\nDevice is connected, but this computer is not yet authorized.\n-----------------------------------------------------------------",
        "val_adb_unauth_instructions": " CHECK YOUR PHONE SCREEN NOW:\n 1. Unlock your phone screen.\n 2. You will see a dialog: 'Allow USB debugging?'.\n 3. Check: '[x] Always allow from this computer'.\n 4. Tap: OK / ALLOW.\n\nWaiting for on-screen authorization...",
        "val_adb_auth_success": "[OK] Device authorized via ADB.",
        "val_adb_rebooting": "[INFO] Authorized device detected via ADB. Rebooting into Fastboot...",
        "val_audit_running": "\n[*] Running official cryptographic audit with Xiaomi server (ahaUnlock)...",
        "val_win_confirmed": "=================================================================\n[CONFIRMED] UNLOCK PERMISSION ACTIVATED IN XIAOMI SERVERS!\n• Status: Official waiting period in progress\n• Remaining time: {hours} hours\n• Unlock officially available on: {date}\n=================================================================",
        "val_win_descheduled": "[OK] Daily background task disabled automatically. No further sniping required.",
        "val_win_ready": "=================================================================\n[READY] Waiting period has elapsed! Device is ready to unlock via MiFlash.\n=================================================================",
        "val_fail_phone_missing": "[!] Error 20041: Account does not have an associated phone number. Link it in Mi Account.",
        "val_fail_not_authorized": "[!] Device is not yet authorized. Daily background task remains active for tomorrow.",
        "val_rebooting_android": "[*] Safely rebooting device back to Android OS...",
    ...
    "es": {
        ...
        "login_community_title": "\n[INFO] Red de Inteligencia Colectiva (Comunidad Reciproca):",
        "login_community_desc": "   Permite sincronizar el bias optimo y calibracion descubierta por nodos ganadores.\n   Bajo la Regla de Reciprocidad, recibir el bias comunitario requiere aportar metricas anonimas del disparo.",
        "login_community_prompt": "Deseas participar en la Red de Inteligencia Colectiva? (S/n): ",
        ...
        "status_is_pass": "• Estado del Permiso: {is_pass}",
        ...
        # Button and Pass state human mappings
        "btn_ready": "[HABILITADO] Lista para solicitar cupo (codigo 1)",
        "btn_cooldown": "[ENFRIAMIENTO] Bloqueada temporalmente (codigo 2)",
        "btn_too_new": "[RESTRINGIDO] Cuenta con menos de 30 dias (codigo 3)",
        "btn_unknown": "[DESCONOCIDO] Estado de boton no reconocido (codigo {state})",
        "pass_approved": "[APROBADO] Permiso de bootloader activo (codigo 1)",
        "pass_pending": "[PENDIENTE] Sin permiso aun, requiere solicitud diaria (codigo 4)",
        "pass_unknown": "[DESCONOCIDO] Estado de permiso {is_pass}",
        # Schedule
        ...
        "res_account_error": "[ERROR_CUENTA] Error de cuenta. Intenta de nuevo despues de {deadline}.",
        ...
        "res_apply_failed": "[FALLIDA] Solicitud fallida. Intenta mas tarde.",
        "res_try_minute": "[ESPERA] Intenta de nuevo en un minuto.",
        ...
        # Validator & USB assistant
        "val_silent_pass_alert": "\n=================================================================\n[AVISO - POSIBLE APROBACION SILENCIOSA DETECTADA]\nLos servidores de Xiaomi estuvieron saturados. Es muy comun que\nla solicitud se haya aprobado internamente aunque la API diga agotado.\n=================================================================",
        "val_silent_prompt_ask": "Deseas comprobar si tu permiso fue aprobado silenciosamente? (S/n): ",
        "val_prompt_header": " [AUDITORIA DE BOOTLOADER POR USB]\n Conecta tu celular por cable USB a esta computadora:\n   • Opcion 1: Encendido normal con Depuracion USB activa (ADB).\n   • Opcion 2: Apagado en modo FASTBOOT (Volumen Abajo + Encendido).",
        "val_prompt_instructions": " Asegurate de que el cable este firmemente conectado antes de presionar Enter.",
        "val_prompt_press_enter": "\nPresiona [ENTER] cuando el cable este conectado (o 's' para saltar): ",
        "val_prompt_retry": "Deseas reintentar la conexion USB? (S/n): ",
        "val_no_device_found": "[!] No se detecto ningun dispositivo en USB (ni ADB ni Fastboot).",
        "val_adb_unauth_notice": "\n-----------------------------------------------------------------\n[AVISO DE AUTORIZACION ADB]:\nEl celular esta conectado, pero falta autorizar esta computadora.\n-----------------------------------------------------------------",
        "val_adb_unauth_instructions": " REVISA LA PANTALLA DE TU CELULAR AHORA:\n 1. Desbloquea la pantalla de tu celular.\n 2. Veras una ventana: 'Permitir depuracion USB?'.\n 3. Marca la casilla: '[x] Permitir siempre desde esta computadora'.\n 4. Toca en: ACEPTAR / PERMITIR.\n\nEsperando autorizacion en pantalla...",
        "val_adb_auth_success": "[OK] Dispositivo autorizado via ADB.",
        "val_adb_rebooting": "[INFO] Dispositivo autorizado detectado en ADB. Reiniciando a Fastboot...",
        "val_audit_running": "\n[*] Ejecutando auditoria criptografica oficial con Xiaomi (ahaUnlock)...",
        "val_win_confirmed": "=================================================================\n[CONFIRMADO] PERMISO DE DESBLOQUEO ACTIVO EN SERVIDORES DE XIAOMI\n• Estado: Periodo de espera oficial en curso\n• Tiempo restante: {hours} horas\n• Desbloqueo oficialmente disponible el: {date}\n=================================================================",
        "val_win_descheduled": "[OK] Tarea diaria del cron desprogramada del sistema automaticamente.",
        "val_win_ready": "=================================================================\n[LISTO] El periodo de espera expiro. El dispositivo esta listo para desbloquear en PC.\n=================================================================",
        "val_fail_phone_missing": "[!] Error 20041: La cuenta Mi no tiene numero de telefono asociado. Vinculalo en Cuenta Mi.",
        "val_fail_not_authorized": "[!] El dispositivo no tiene autorizacion activa aun. La tarea diaria seguira programada.",
        "val_rebooting_android": "[*] Reiniciando celular de vuelta a Android de forma segura...",
        # Feedback decision reasons
